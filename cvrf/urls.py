...
urlpatterns = patterns('cvrf.views',
	...
	url(r'^([mM][iI][cC][rR][oO][sS][oO][fF][tT])/rawxml/([mM][sS]\d{2}-\d{3})', views.rawxml),
	...
	url(r'^([mM][iI][cC][rR][oO][sS][oO][fF][tT])/prettyxml/([mM][sS]\d{2}-\d{3})', views.prettyxml),
	...
	url(r'^([mM][iI][cC][rR][oO][sS][oO][fF][tT])/xml/([mM][sS]\d{2}-\d{3})', views.cvrfxml),
	...
	url(r'^[mM][iI][cC][rR][oO][sS][oO][fF][tT]/import', views.import_msrc_cvrf),
	...
	url(r'^([mM][iI][cC][rR][oO][sS][oO][fF][tT])', views.index_cvrf),
	url(r'^([rR][eE][dD][hH][aA][tT])', views.index_cvrf),
	url(r'^([oO][rR][aA][cC][lL][eE])', views.index_cvrf),
	url(r'^([cC][iI][sS][cC][oO])',views.index_cvrf),
	url(r'^catalog', TemplateView.as_view(template_name='cvrf_catalog.html')),
